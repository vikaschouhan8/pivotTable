...
#fm-pivot-view b, #fm-pivot-view u, #fm-pivot-view i, #fm-pivot-view center,
...
#fm-toolbar-wrapper b, #fm-toolbar-wrapper u, #fm-toolbar-wrapper i, #fm-toolbar-wrapper center,
...
@font-face {
  ...
  src: url("../assets/flexmonster-icons.woff?v2.7.0") format("woff"), 
       url("../assets/flexmonster-icons.ttf?v2.7.0") format("truetype"), 
       url("../assets/flexmonster-icons.svg#flexmonster-icons?v2.7.0") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
#fm-toolbar-wrapper {
    ...
    a.fm-ui-btn.fm-ui-btn-close:before {
        .fm-ui-icon;
        content: "\e903";
        font-size: 26px;
    }
...
#fm-pivot-view #fm-filter-view {
    ...
    .fm-filters-table.fm-ft-contentheight-220 .fm-filters-table-content {
        height: 222px;
    }
...
#fm-pivot-view .fm-grid-layout {
    ...
    .fm-draggable:not(.fm-filter-header) {
        cursor: move;
    }
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-cr-inner .fm-select, .fm-cr-inner
...
#fm-toolbar-wrapper {
    ...
    &.fm-layout-580 #fm-toolbar {
        #fm-tab-fields {
            display: none;
        }
    }   
    &.fm-layout-520 #fm-toolbar {
        #fm-tab-fullscreen {
            display: none;
        }
    }
    &.fm-layout-450 #fm-toolbar {
        #fm-tab-format {
            display: none;
        }
    }
    &.fm-layout-400 #fm-toolbar {
        .fm-toolbar-group-right {
            display: none;
        }
    }
