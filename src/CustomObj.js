                                ...
                                <tr>
                                    ...
                                    {typeof tempData === "object" && Object.keys(tempData).forEach(function (monthNameKey) {
                                        if (monthNameKey !== "type" && monthNameKey !== "key") {
                                            ...
                                            // console.log("month Name Key ", monthNameKey);
                                            // console.log("tdSalesPerson ", tdSalesPerson);
                                            // console.log("td[monthNameKey] ", td[monthNameKey]);
                                            // console.log("Month SP array", td);

                                        }
                                    })}
                                    {/* starts month Sales person */}
                                    { 
                                        td.map((item,i)=>{
                                            return(
                                                <td>{item}</td>
